...
echo '実行開始[メモリ使用量]：' . memory_get_usage() / (1024 * 1024) . "MB\n";
echo '実行開始[メモリ最大使用量]：' . memory_get_peak_usage() / (1024 * 1024) . "MB\n";
echo "-----------------------------------------------\n";
...
echo '処理1実行後[メモリ使用量]：' . memory_get_usage() / (1024 * 1024) . "MB\n";
echo '処理1実行後[メモリ最大使用量]：' . memory_get_peak_usage() / (1024 * 1024) . "MB\n";
echo "-----------------------------------------------\n";
...
echo '処理2実行後[メモリ使用量]：' . memory_get_usage() / (1024 * 1024) . "MB\n";
echo '処理2実行後[メモリ最大使用量]：' . memory_get_peak_usage() / (1024 * 1024) . "MB\n";
echo "-----------------------------------------------\n";
